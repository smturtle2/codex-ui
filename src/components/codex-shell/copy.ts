...
const UI_COPY = {
  en: {
    ...
    composer: {
      ...
      showSettings: "Session controls",
      hideSettings: "Hide controls",
      sessionAria: (
    ...
    home: {
      ...
      noOtherThreads: "No other threads yet.",
      noMatchingThreads: "No matching threads.",
  ...
  ko: {
    ...
    home: {
      ...
      noOtherThreads: "다른 thread는 아직 없습니다.",
      noMatchingThreads: "일치하는 thread가 없습니다.",
      sessionLabel: "현재 세션",
      openThread: "열기",
      updatedSort: "최근순",
